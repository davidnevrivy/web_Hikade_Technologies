...
export default function HomePage() {
  ...
  const platforms = [
    ...
    { name: "CryoLyze", category: lang === "en" ? "Laboratory freeze-drying" : "Laboratorní mrazové sušení",    desc: t.cryoDesc, status: t.pDev2, statusColor: "text-yellow-400",    href: "/products/cryolyze", image: "/assets/products/cryolyze/cryolyze-1-tight.png",            payload: "< 3.5 kPa", mass: "LN2",                                 axes: "AISI 316L" },
  ];
