...
const T = {
  en: {
    ...
    heroP2: "Low pressure, extreme temperature, mass and power constraints define every engineering decision at 16–23 km altitude. Our gimbal platforms are designed from the ground up for these conditions.",
    cta1: "Explore PATRON",
    cta2: "Explore BEETLE",
    cta3: "Request Consultation",
    stats: [
      { val: "16–23 km", label: "Flight level" },
      { val: "−80/80 °C", label: "Operating temperature" },
    ...
    whyP1: "At 16–23 km altitude, payloads on HAPS platforms and stratospheric balloons face an environment fundamentally different from ground or low-orbit applications. The platform moves. The payload must not — or must follow a precise trajectory.",
    ...
    useCases: [
      { title: "HAPS Platforms", desc: "Payload pointing and stabilization for High-Altitude Pseudo-Satellite platforms operating at 16–23 km altitude. Camera systems, optical sensors, antennas and communication payloads.", icon: "⊕" },
    ...
    challenges: [
      ...
      { title: "Operating Temperature Range", desc: "Operating temperature range of −80 to 80 °C. Material selection, lubrication type, bearing preload, actuator characteristics and electronics behaviour are all temperature-dependent." },
  ...
  cs: {
    ...
    heroP2: "Nízký tlak, extrémní teploty, hmotnostní a výkonová omezení definují každé inženýrské rozhodnutí ve výšce 16–23 km. Naše gimbalové platformy jsou navrženy od základu pro tyto podmínky.",
    cta1: "Prozkoumat PATRON",
    cta2: "Prozkoumat BEETLE",
    cta3: "Požádat o konzultaci",
    stats: [
      { val: "16–23 km", label: "Letová hladina" },
      { val: "−80/80 °C", label: "Provozní teplota" },
    ...
    whyP1: "Ve výšce 16–23 km čelí payloady na HAPS platformách a stratosferických balonech prostředí zásadně odlišnému od pozemních nebo nízkoorbitalních aplikací. Platforma se pohybuje. Payload se nesmí — nebo musí sledovat přesnou trajektorii.",
    ...
    useCases: [
      { title: "HAPS platformy", desc: "Polohování a stabilizace payloadu pro platformy HAPS operující ve výšce 16–23 km. Kamerové systémy, optické senzory, antény a komunikační payloady.", icon: "⊕" },
    ...
    challenges: [
      ...
      { title: "Rozsah provozní teploty", desc: "Provozní teplota v rozsahu −80 až 80 °C. Volba materiálů, typ mazání, předpětí ložisek, charakteristiky pohonů a chování elektroniky jsou závislé na teplotě." },
