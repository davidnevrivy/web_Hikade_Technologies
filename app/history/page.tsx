...
const T = {
  en: {
    ...
    overviewStats: [
      ...
      { val: "ESA BIC", label: "Czech Republic program" },
      { val: "Active", label: "PATRON status" },
      { val: "2-axis", label: "Gimbal configuration" },
      { val: "16–23 km", label: "Target altitude" },
    ],
    ...
    esaP1: "Hikade Technologies is a participant in the ESA Business Incubation Centre Czech Republic (ESA BIC) — part of the pan-European ESA BIC network that supports companies developing technologies with space relevance.",
    ...
    esaItems: [
      { title: "Program", val: "ESA Business Incubation Centre Czech Republic (ESA BIC)" },
    ...
    timeline: [
      ...
      },
      {
        ...
        details: ["Parametric 3D CAD and assembly management", "Structural, thermal and modal analysis capability", "Manufacturing, CNC and precision assembly", "Embedded firmware: real-time control, RS-485, Ethernet", "Full mechatronic integration: mechanics + electronics + firmware", "Technical documentation as a standard deliverable"],
      },
      {
        phase: "04",
      ...
      },
      {
        ...
        summary: "Primary HAPS gimbal platform — active development",
        ...
        details: ["Payload capacity: up to ~18 kg", "Configuration: two-axis (azimuth and elevation)", "System mass: approximately 8 kg", "Nominal power: 200–400 W depending on configuration", "Purpose-built for 16–23 km altitude operation", "Status: active development platform"],
      },
      {
        phase: "06",
      ...
      },
      {
        ...
        summary: "ESA BIC participant + Technology Incubation programme for PATRON",
        desc: "Hikade Technologies became a participant in the ESA Business Incubation Centre Czech Republic (ESA BIC) — an external validation of the technical relevance and commercial potential of the stratospheric positioning development. Simultaneously, the PATRON gimbal platform was supported through the Technology Incubation programme, which supported the maturation of the platform from early prototype toward a validated, commercially deployable system.",
      ...
      },
      {
        ...
        desc: "The current focus of Hikade Technologies is on maturing both the PATRON and BEETLE platforms and identifying the right HAPS platform partnership for the first stratospheric flight validation campaign. In parallel, the AVPS system continues to be refined for customer-specific configurations, the CryoLyze platform is in active engineering development, and the custom engineering services portfolio continues to grow with industrial R&D and aerospace-adjacent customers.",
        details: ["PATRON: platform maturation, seeking HAPS platform partnership for flight", "BEETLE: active development, targeting lighter-class HAPS and balloon platforms", "AVPS: ongoing configuration and customer-specific adaptation", "CryoLyze: engineering development, laboratory integration", "Custom engineering: growing portfolio of industrial R&D clients", "Geographic focus: European HAPS, aerospace and industrial R&D market"],
      },
    ],
  },
  cs: {
    ...
    overviewP2: "Přesun směrem k letectví a HAPS nebyl náhlým obratem. Byl výsledkem postupné, technicky motivované progrese: inženýrské schopnosti vyvinuté pro náročné průmyslové zákazníky — lehké konstrukce, vestavěné řízení v omezených prostředích, tribologie bez standardního mazání, systémová integrace při přísných hmotnostních a výkonových rozpočtech — se ukázaly být přesně těmi schopnostmi potřebnými pro stratosferické inženýrství payloadu.",
    ...
    overviewStats: [
      ...
      { val: "ESA BIC", label: "Program ČR" },
      { val: "Aktivní", label: "Status PATRON" },
      { val: "2-osý", label: "Konfigurace gimbalu" },
      { val: "16–23 km", label: "Cílová výška" },
    ],
    ...
    esaBadge: "ESA BIC Czech Republic",
    esaH2: "ESA Business Incubation Centre",
    esaP1: "Hikade Technologies je účastníkem programu ESA Business Incubation Centre Czech Republic (ESA BIC) — součásti celoevropské sítě ESA BIC podporující společnosti vyvíjející technologie s kosmickou relevancí.",
    ...
    timeline: [
      ...
      },
      {
        ...
        summary: "Vybudován kompletní inženýrský stack: CAD · analýzy · výroba · firmware · integrace",
        desc: "Raná projektová zkušenost odhalila, že nejnáročnější zákazníci nepotřebují jen konstrukční návrh, jen elektroniku nebo jen firmware — ale vše tři integrované dohromady. Hikade Technologies systematicky vybudovala kompletní inženýrský stack: parametrický CAD design, strukturální a tepelné výpočtové analýzy, výrobní a montážní infrastrukturu, vývoj vestavěného firmware a řízení v reálném čase, a kompletní mechatronickou systémovou integraci. Tento stack schopností nyní pokrývá každý projekt Hikade od konceptu po validovaný systém.",
        details: ["Parametrické 3D CAD a správa sestav", "Schopnost strukturální, tepelné a modální analýzy", "Výroba, CNC a přesná montáž", "Vestavěný firmware: řízení v reálném čase, RS-485, Ethernet", "Kompletní mechatronická integrace: mechanika + elektronika + firmware", "Technická dokumentace jako standardní součást dodávky"],
      },
      {
        phase: "04",
      ...
      },
      {
        ...
        summary: "Účastník ESA BIC + program technologické inkubace pro PATRON",
        desc: "Hikade Technologies se stala účastníkem programu ESA Business Incubation Centre Czech Republic (ESA BIC) — externího potvrzení technické relevance a komerčního potenciálu vývojového směru stratosferického polohování. Paralelně byla gimbalová platforma PATRON podpořena programem technologické inkubace, který podpořil zrání platformy od raného prototypu směrem k validovanému, komerčně nasaditelnému systému.",
