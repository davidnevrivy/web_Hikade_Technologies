        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-2xl">
            <nav className="text-xs font-mono text-white/40 mb-6 flex items-center gap-2">
              ...
              <span>/</span>
              <span className="text-[#63C3B5]">Micro BEETLE</span>
            </nav>
            ...
            <div>
              ...
              <div className="mt-8 p-4 border border-white/15 rounded bg-[#1F2019]">
                <p className="text-xs text-white/50 leading-relaxed">
                  <span className="text-white/70 font-mono">STATUS:</span> Micro BEETLE is an early concept and first development direction — not a validated, serial or catalog product. All parameters are development targets subject to change. Co-development approach required.
                </p>
              </div>
            </div>
            <div>
              ...
              <h3 className="text-sm font-mono text-[#63C3B5] mb-4 tracking-widest uppercase">Concept Specifications</h3>
              ...
              <p className="text-xs text-white/35 mt-3 font-mono">All values are concept targets. Final parameters to be defined with the platform owner.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#1F2019]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 max-w-2xl">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="/products/beetle" className="px-6 py-3 border border-white/30 text-white font-semibold rounded hover:border-[#63C3B5]/50 transition-colors">Also see: BEETLE</Link>
          </div>
        </div>
      </section>
    </div>
