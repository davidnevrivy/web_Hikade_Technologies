        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-2xl">
            <nav className="text-xs font-mono text-white/40 mb-6 flex items-center gap-2">
              ...
              <span>/</span>
              <span className="text-[#63C3B5]">Motor Stand</span>
            </nav>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              ...
              <div className="mt-8">
                <h3 className="text-sm font-mono text-[#63C3B5] mb-4 tracking-widest uppercase">Delivery Scope</h3>
                <ul className="space-y-2">
                  {["Concept design", "Feasibility study", "Component research and selection", "FEM and modal verification", "Manufacturing drawings", "Manufacturing", "Installation", "Commissioning", "Technical documentation", "Operation manual"].map((item) => (
                    <li key={item} className="flex items-center gap-3 text-sm text-white/65">
                      <span className="text-[#63C3B5] text-xs">◎</span>
                      {item}
                    </li>
                  ))}
                </ul>
            ...
            <div>
              ...
              <h3 className="text-sm font-mono text-[#63C3B5] mb-4 tracking-widest uppercase">Reference Specifications</h3>
              ...
              <p className="text-xs text-white/35 mt-3 font-mono">Reference values from completed project. Custom systems are defined per customer requirements.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#1F2019]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 max-w-2xl">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/contact" className="px-6 py-3 bg-[#63C3B5] text-black font-semibold rounded hover:bg-[#63C3B5]/90 transition-colors">Start a Project</Link>
            <Link href="/products/testing-fixtures" className="px-6 py-3 border border-white/30 text-white font-semibold rounded hover:border-[#63C3B5]/50 transition-colors">Also see: Testing Fixtures</Link>
          </div>
        </div>
      </section>
    </div>
